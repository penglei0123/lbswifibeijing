...
public class Configs {
	...
	// unit:ms
	public static int ALIYUN_OSS_OBJECT_URL_EXPIRATION = 3600 * 1000;
	...
	// 全局建筑编码
	public static String BUILDING = "zhonggauncun";

	public static String BUILDING_NAME_CHINESE = "中关村";
	// 楼层之间逗号隔开，支持连续楼层，如：B1-B2,F1-F4,F9
	public static String FLOOR_LIST = "F9";
	// 是否启用缓存（redis）
