    ...
    <ul class="am-list admin-sidebar-list">
      ...
      <li class="admin-parent">
        ...
        <ul class="am-list am-collapse admin-sidebar-sub am-in" id="info-center">
          <li id="home"><a href="<%=basePath%>home"><span class="am-icon-home"></span> 人流总览</a></li>
        <li id="customer_realtime"><a href="<%=basePath%>customer/realtime"><span class="am-icon-area-chart"></span> 实时热力图</a></li>    
        <li id="position_realtime"><a href="<%=basePath%>position/realtime"><span class="am-icon-area-chart"></span> 实时人流分布</a></li>      
        </ul>
      </li>
      <li class="admin-parent">
        ...
        <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-track">
          ...
          <li id="heatmap_history"><a href="<%=basePath%>heatmap/history"><span class="am-icon-area-chart"></span> 历史热力图</a></li>
